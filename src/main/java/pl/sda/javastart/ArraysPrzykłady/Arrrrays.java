package pl.sda.javastart.ArraysPrzykłady;

import java.util.Arrays;

public class Arrrrays {
    public static void main(String[] args) {
        ...
        //copyOF  kopiowanie jednej tablicy do drugiej
        ...
        //equals
        System.out.println("Arrays.equal(number, number2");
